...
// Fix error about implicit declaration
...
bool print_full_tree = false, print_simplified_tree = false,
     print_symbol_table_contents = false, print_generated_program = true,
